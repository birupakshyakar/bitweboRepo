...
<head>
    ...
    <title>Communicative English - My English Sir</title>
                ...
                <ul class="nav navbar-nav pull-right mainNav">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="communicative.php">Communicative English</a></li>
    ...
    <section class="container mt-10">
        <div class="row">
            ...
            <?php
                ...
                $sql="select * from pdf_details where subject='3' order by id desc";
